...
import { faqs } from "@/lib/explainers/butterfly";
  ...
  return (
    <SectionWrapper id="faq" layout="centered">
      ...
      <p className="mt-5 font-sans text-base leading-relaxed text-text-secondary">
        The questions that scientists and curious people keep asking about one of
        biology&rsquo;s most dramatic processes.
      </p>
