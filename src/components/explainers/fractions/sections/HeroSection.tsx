...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Division symbol background SVG */}
      <div
        aria-hidden="true"
      ...
      >
        ...
        >
          <title>Division symbol</title>
          <circle cx="200" cy="120" r="40" fill="var(--space-blue)" />
          <rect x="100" y="185" width="200" height="30" rx="15" fill="var(--amber)" />
          <circle cx="200" cy="280" r="40" fill="var(--space-blue)" />
        </svg>
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        ...
        >
          Every 5th grader is taught to &ldquo;flip and multiply&rdquo; when dividing
          fractions. Almost none of them are told why.
        </p>
        ...
        >
          {[
            ...
            { value: "\u221E", label: "problems it solves" },
